# PAUP
Official PyTorch code for the SIGIR 2022 poster paper "[Progressive Self-Attention Network with Unsymmetrical Positional Encoding for Sequential Recommendation](https://dl.acm.org/doi/pdf/10.1145/3477495.3531800)". In this paper, to progressively extract a series of user's local sequential patterns (see below figure). We propose a novel convolution-based self-attention network, namely [PAUP](https://github.com/YuehuaZhu/ProxyGML/blob/main/loss/ProxyGML.py), which is easy to implement (see below figure).

<img src="https://github.com/YuehuaZhu/PAUP/blob/main/pic/illustration.png" width="400" alt="illustration"/><img src="https://github.com/YuehuaZhu/PAUP/blob/master/pic/framework.png" width="400" alt="pipline"/>
